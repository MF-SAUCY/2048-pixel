...
LIGHT = [
    ("2",     "#eee4da", None),
    ("4",     "#ede0c8", None),
    ("8",     "#f2b179", (0.960, 0.695, 0.455)),
    ("16",    "#f59563", (0.985, 0.575, 0.355)),
    ("32",    "#f67c5f", (1.000, 0.470, 0.340)),
    ("64",    "#f65e3b", (1.000, 0.345, 0.190)),
    ("128",   "#edcf72", (0.940, 0.815, 0.420)),
    ("256",   "#edcc61", (0.945, 0.800, 0.345)),
    ("512",   "#edc850", (0.950, 0.785, 0.270)),
    ("1024",  "#edc53f", (0.955, 0.772, 0.190)),
    ("2048",  "#edc22e", (0.965, 0.760, 0.100)),
    ("super", "#3c3a32", None),
]
...
if __name__ == "__main__":
    report(LIGHT, False, "sRGB fallback ramp")
    report(LIGHT, True, "display-p3 ramp (what the Pixel shows)")
